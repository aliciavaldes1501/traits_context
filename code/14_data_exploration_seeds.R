...
dataseeds1<-read.table("seeds_up_p_means.txt",header=T,sep="\t",dec=",")
head(dataseeds1)
tail(dataseeds1)
str(dataseeds1)
...
dataseeds2<-read.table("seeds_means.txt",header=T,sep="\t",dec=",")
head(dataseeds2)
tail(dataseeds2)
str(dataseeds2)
...
#See how to calculate n seeds per plant in Tånga
